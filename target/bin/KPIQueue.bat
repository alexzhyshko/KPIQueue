...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="KPIQueue" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" /KPIQueue/src/main/java/main/Main.java %CMD_LINE_ARGS%
